...
sed -i "s/ofa-v2-ib0 u2.0 nonthreadsafe default libdaplofa.so.2 dapl.2.0 \".*$/ofa-v2-ib0 u2.0 nonthreadsafe default libdaplofa.so.2 dapl.2.0 \"$IP_ADDRESS 0\" \"\"/g" /etc/rdma/dat.conf
